...
export default function (context: Context) {
    ...
    app.post("/signup", async (req, reply) => {
        ...
        const body = req.body as { nome: string, cognome: string, email: string, username: string, password: string, controlloPassword: string }
        ...
        if (body.password !== body.controlloPassword) {
            console.log(body.password, body.controlloPassword)
